...
class _AddCategoryState extends State<AddCategory> {
  ...
  SingleChildScrollView buildTabExpense(double doubleHeight, BuildContext context) {
  ...
  SingleChildScrollView buildTabIncome(double doubleHeight, BuildContext context) {
    return SingleChildScrollView(
              child: Container(
                padding: const EdgeInsets.all(10),
                child: Column(
